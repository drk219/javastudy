...
public class MainClass {
  ...
  public static void method1() {
     ...
     * 2. 각 젼수 구분을 위해서 인덱스를 활용한다.
     * 3. 구성 
     *    1) 배열이름 : 모든 변수의 대표 이름
     *    2) 배열길이 : 변수의 개수
     *    3) 인덱스   : 변수를 구분하는 숫자 (0부터 시작하는 정수)
     *    4) 배열요소 : 각 변수를 의미(배열 이름과 대괄호[]와 임덱스를 조합해서 사용.)
     */
  ...
  public static void method3() {
    ...
    // 배열과 for 문 (가급적 요 방식 외우도록!!)   --'for (int i = 0; i <= 4)' 로는 잘 안씀
