  ...
  public static void main(String[] args) {
    ...
    while(true) {
      ...
      switch(choice) {
        ...
        case "0" : JOptionPane.showMessageDialog(null, "사용자 앱을 종료합니다."); return;      // 반환해야할 값이 없으므로 완전 종료
        default : JOptionPane.showMessageDialog(null, "잘못된 입력입니다. 다시 선택하세요.");   // case 에 해당되는 번호가 아니라면
      }
      if(view != null) {
