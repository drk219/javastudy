...
public class MainClass {
   ...
   * 
   * 1. 오라클 데이터베이스에 접속하기 위해 필요한 드라이버 클래스이다.
   * 2. 오라클에서 만들어서 배포한다.
   * 3. 18c XE 버전의 경우 C:\app\goodee\product\18.0.0\dbhomeXE\jdbc\lib\ojdbc.jar 파일을 프로젝트의 build path 에 등록해야 한다.
   */
  ...
  public static void method2() {  // 민감정보 노출 위험!!!
