...
public class Class01_String {
  ...
  public static void method2() {
    ...
    // String Literal : "문자열"
    // String Literal 은 JVM이 관리한다. -> 동일한 Literal 은 재사용한다.
    ...
    /*
     * In this example, both str1 and str2 point to the same string literal "a" in the string constant pool. 
     * Both of the string literal has the same HashCode which is '1627800613'.
     * Java optimizes memory usage by 'reusing' string literals in the constant pool.
     */
  ...
  public static void method3() {
    ...
    /*
     * Created in the heap memory using the new keyword.
     * stored in different locations in memory.
     * When new String is made it has its own HashCode.
     * Which means that str1 and str2 has different Code. 
     * str1 : 2065530879 / str2 : 697960108
     */
  ...
  public static void method4() {
    ...
    // equals (동등비교) 메소드 : 같은 문자열이면 true 반환
    // equalsIgnorecase : 같은 문자열이면 true 반환 (대소문자 무시한다.)
    
    String str1 = "a";
    String str2 = "A";
    
    System.out.println(str1.equals(str2));            // a = a 만 같을 수 있다.
    System.out.println(str1.equalsIgnoreCase(str2));  // a = A 정도는 같다고 할 수 있다.
  ...
  public static void method7() {
    ...
    // indexOf     :  전달한 문자열이 발견된 첫번째 인덱스를 반환, 없으면 -1 반환
    // lastIndexOf :  전달한 문자열이 발견된 마지막 인덱스를 반환, 없으면 -1 반환
    
    String str = "hello world apple";
    
    System.out.println(str.indexOf(" "));      // hello 랑 world 사이의 공백 위치
    System.out.println(str.lastIndexOf(" "));  // world 랑 apple 사이의 공백 위치
  ...
  public static void method8() {
    ...
    // (starting from the specified beginIndex to the end of the string)
    
    // substring(int beginIndex, int endIndex) : beginIndex 부터 endIndex 이전까지 반환
    // (starting from the specified beginIndex and ending at endIndex - 1)
    
    String str = "hello world";
    int spaceIndex = str.indexOf(" ");    // 띄어쓰기의 위치
    
    System.out.println(str.substring(0));                   // hello world
    System.out.println(str.substring(0, spaceIndex));       // hello
    System.out.println(str.substring(spaceIndex + 1, 11));  // world
  ...
  public static void method12() {
    ...
    // replaceAll : 어떵 정규식 패턴을 다른 문자열로 변환한 문자열로 반환
    
    String str = "192.168.0.214";
    
    System.out.println(str.replace(".", "_"));     // 192_168_0_214
    System.out.println(str.replaceAll(".", "_"));  // _____________
    
  }
  
  public static void method13() {
    
    // split : 지정한 정규삭 패톤으로 문자열을 분리한 String[] 을 반환
    // join  : String[] 의 모든 요소와 전달한 문자열을 연결한 문자열을 반환
    
    String str = "aaa.bbb.ccc.ddd.txt";
    
    String[] result = str.split("\\.");
    System.out.println(Arrays.toString(result));    // [aaa, bbb, ccc, ddd, txt]
    System.out.println(result[result.length - 1]);  // txt
  ...
  public static void practice02() {
    ...
    // 1. 한 글자씩 비교하기 (substring? equals?)
        /*
         * - 5글자인 경우 비교할 문자들의 인덱스 비교
         *     앞     뒤
         *     0      4
         *     1      3
         *     2      2
         ...
         *     4      0
         * 
         * - n 글자인 경우 비교할 문자들의 인덱스 비교
         *     앞     뒤
         *     i     (n - i - 1)
         */
    
    boolean result = true;
    for(int i = 0, length = word.length(); i < word.length() /2; i++) {
