...
public class MainClass {
  ...
  public static void main(String[] args) {
     ...
     * 3. Snake case  : 각 단어 연결을 밑줄(_)로 하는 방식          (상수)
     */
    ...
    /*
     * <변수> 
     * 1. 어떤 값을 저장하기 위해 메모리에 할당된 저장소를 의미
     * 2. 변수를 선언한 뒤 사용할 수 있다
     * 3. 저장하려는 데이터의 종류에 따라 2가지로 구분한다.
     *   1) 기본 자료형(타입)
     *     (1) 값 자체를 저장하는 로우데이터 타입
     *     (2) 8가지 타입이 제공됨
     *         byte, short, int, long, float, double, char, boolean
     *   2) 참조 자료형(타입)
     *     (1) 값이 저장된 참조값을 저장하는 레퍼런스 데이터 타입
    ...
    // long : 8바이트 정수(*)
    long c = 10000000000L;  //숫자 길어지면 뒤에 L붙이면 빨간줄 사라짐
    ...
    // boolean : 크기x , 논리값(true, false) (*)
    boolean isALive = false;
    System.out.println(isALive);
    
    /*
     * <이스케이프 시퀀스> 
     * 1. 역슬래시로 시작하는 특수 문자를 의마한다.
     * 2. 종류
     *    1) 줄바꿈 : \n
     *    2) 탭     : \t
     *    3) 따옴표 
