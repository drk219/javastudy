...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    student1.addBook(new Book("979-11-6224-187-6", "혼자 공부하는 SQL"));
    student1.addBook(new Book("979-11-6224-187-7", "혼자 공부하는 파이썬"));
    student1.addBook(new Book("979-11-6224-187-8", "혼자 공부하는 C++"));
    student1.addBook(new Book("979-11-6224-187-9", "혼자 공부하는 리눅스"));
